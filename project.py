...
def main_app():
            ...
            if twitter_option == "Paste URL":
                ...
                # if url is valid
                    ...
                    try:
                        ...
                        st.error(
                            "Sorry we could not find comments. Please check your internet connection and retry or paste a new link!")
                        st.stop()
            ...
            # Searching for a topic
                ...
                try:
                    ...
                    replies = obj.get_topic_tweets(topic, int(elements))
                        ...
                        st.error("Sorry we could not find comments. Please check your internet connection retry or type a new topic!")
                        st.stop()
        ...
        # FACEBOOK DATA COLLECTION
            ...
            if url_conf is None:
                ...
                try:
                    ...
                    st.error("Sorry we could not find comments. Please check your internet connection and retry or paste a new Facebook url")
                    st.stop()
    ...
    # STEP 2 DATA ANALYSIS
        ...
        st.sidebar.write('The processes performed are: \n Popularity Analysis\n Hate Speech Analyis')
        ...
        try:
            ...
            st.markdown("<h2 style='text-align: center; color: #c7f0db;'> Individual Entity Mentions </h2", unsafe_allow_html=True)
            ...
            st.markdown("<h2 style='text-align: center; color: #c7f0db;'> Polarity Distribution among Top 3 Politicians Mentioned </h2", unsafe_allow_html=True)
            ...
            st.error("Sorry!! The entities collected are not enough for analysis. Please try again using a different data sample.")
